...
(function (process){
"use strict";var _={isPlainObject:require("lodash-compat/lang/isPlainObject"),indexOf:require("lodash-compat/array/indexOf")};module.exports.__bind=function(e,o){return function(){return e.apply(o,arguments)}};var log=module.exports.log=function(){console&&"test"!==process.env.NODE_ENV&&console.log(Array.prototype.slice.call(arguments)[0])};module.exports.fail=function(e){log(e)},module.exports.optionHtml=function(e,o){return'<tr><td class="optionName">'+e+":</td><td>"+o+"</td></tr>"};var resolveSchema=module.exports.resolveSchema=function(e){return _.isPlainObject(e.schema)&&(e=resolveSchema(e.schema)),e};module.exports.simpleRef=function(e){return void 0===e?null:0===e.indexOf("#/definitions/")?e.substring("#/definitions/".length):e},module.exports.extractExtensions=function(e,o,n){e&&o&&"string"==typeof e&&0===e.indexOf("x-")&&(o.vendorExtensions=o.vendorExtensions||{},o.vendorExtensions[e]=n||o[e])};


}).call(this,require('_process'))
},{"_process":157,"lodash-compat/array/indexOf":49,"lodash-compat/lang/isPlainObject":145}],5:[function(require,module,exports){
(function (Buffer){
"use strict";var helpers=require("./helpers"),request=require("superagent"),jsyaml=require("js-yaml"),_={isObject:require("lodash-compat/lang/isObject"),keys:require("lodash-compat/object/keys")},JQueryHttpClient=function(){this.type="JQueryHttpClient"},SuperagentHttpClient=function(){this.type="SuperagentHttpClient"},SwaggerHttp=module.exports=function(){};SwaggerHttp.prototype.execute=function(e,t){var r;r=t&&t.client?t.client:new SuperagentHttpClient(t),r.opts=t||{},t&&t.requestAgent&&(request=t.requestAgent);var n=!1;if("undefined"!=typeof window&&void 0!==window.jQuery&&(n=!0),"options"===e.method.toLowerCase()&&"SuperagentHttpClient"===r.type&&(log("forcing jQuery as OPTIONS are not supported by SuperAgent"),e.useJQuery=!0),this.isInternetExplorer()&&(!1===e.useJQuery||!n))throw new Error("Unsupported configuration! JQuery is required but not available");(e&&!0===e.useJQuery||this.isInternetExplorer()&&n)&&(r=new JQueryHttpClient(t));var o=e.on.response,s=e.on.error,a=function(r){return t&&t.responseInterceptor&&(r=t.responseInterceptor.apply(r,[e])),o(r)},i=function(r){t&&t.responseInterceptor&&(r=t.responseInterceptor.apply(r,[e])),s(r)};return e.on.error=function(e){i(e)},e.on.response=function(e){e&&e.status>=400?i(e):a(e)},_.isObject(e)&&_.isObject(e.body)&&e.body.type&&"formData"===e.body.type&&t.useJQuery&&(e.contentType=!1,e.processData=!1,delete e.headers["Content-Type"]),e=function(e){return t&&t.requestInterceptor&&(e=t.requestInterceptor.apply(e)),e}(e)||e,e.beforeSend?e.beforeSend(function(t){r.execute(t||e)}):r.execute(e),e.deferred?e.deferred.promise:e},SwaggerHttp.prototype.isInternetExplorer=function(){var e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){var t=navigator.userAgent.toLowerCase();if(-1!==t.indexOf("msie")){parseInt(t.split("msie")[1])<=8&&(e=!0)}}return e},JQueryHttpClient.prototype.execute=function(e){var t=this.jQuery||"undefined"!=typeof window&&window.jQuery,r=e.on,n=e;if(void 0===t||!1===t)throw new Error("Unsupported configuration! JQuery is required but not available");return e.type=e.method,e.cache=e.jqueryAjaxCache,e.data=e.body,delete e.jqueryAjaxCache,delete e.useJQuery,delete e.body,e.complete=function(e){for(var t={},o=e.getAllResponseHeaders().split("\n"),s=0;s<o.length;s++){var a=o[s].trim();if(0!==a.length){var i=a.indexOf(":");if(-1!==i){var u=a.substring(0,i).trim(),p=a.substring(i+1).trim();t[u]=p}else t[a]=null}}var d={url:n.url,method:n.method,status:e.status,statusText:e.statusText,data:e.responseText,headers:t};try{var l=e.responseJSON||jsyaml.safeLoad(e.responseText);d.obj="string"==typeof l?{}:l}catch(e){helpers.log("unable to parse JSON/YAML content")}if(d.obj=d.obj||null,e.status>=200&&e.status<300)r.response(d);else{if(!(0===e.status||e.status>=400&&e.status<599))return r.response(d);r.error(d)}},t.support.cors=!0,t.ajax(e)},SuperagentHttpClient.prototype.execute=function(e){var t=e.method.toLowerCase(),r=e.timeout;"delete"===t&&(t="del");var n,o=e.headers||{};try{n=request[t](e.url)}catch(t){if(e.on&&e.on.error){var s={errObj:t,status:500,statusText:t.message||"invalid url"};return void e.on.error(s)}}e.connectionAgent&&n.agent(e.connectionAgent),r&&n.timeout(r),e.enableCookies&&n.withCredentials();var a=e.headers.Accept;if(this.binaryRequest(a)&&n.on("request",function(){this.xhr&&(this.xhr.responseType="blob")}),e.body)if(_.isObject(e.body)&&!Buffer.isBuffer(e.body)){var i=e.headers["Content-Type"]||"";if(0===i.indexOf("multipart/form-data"))if(delete o["Content-Type"],"[object FormData]"==={}.toString.apply(e.body))n.send(e.body);else{var u,p,d;for(u in e.body)if(p=e.body[u],Array.isArray(p))for(d in p)n.field(u,d);else n.field(u,p)}else _.isObject(e.body)&&(e.body=JSON.stringify(e.body),n.send(e.body))}else n.send(e.body);var l;for(l in o)n.set(l,o[l]);"function"==typeof n.buffer&&n.buffer(),n.end(function(t,r){r=r||{status:0,headers:{error:"no response from server"}};var n,o={url:e.url,method:e.method,headers:r.headers};if(!t&&r.error&&(t=r.error),t&&e.on&&e.on.error){if(o.errObj=t,o.status=r?r.status:500,o.statusText=r?r.text:t.message,r.headers&&r.headers["content-type"]&&r.headers["content-type"].indexOf("application/json")>=0)try{o.obj=JSON.parse(o.statusText)}catch(e){o.obj=null}n=e.on.error}else if(r&&e.on&&e.on.response){var s;if(r.body&&_.keys(r.body).length>0)s=r.body;else try{s=jsyaml.safeLoad(r.text),s="string"==typeof s?null:s}catch(e){helpers.log("cannot parse JSON/YAML content")}"function"==typeof Buffer&&Buffer.isBuffer(s)?o.data=s:o.obj="object"==typeof s?s:null,o.status=r.status,o.statusText=r.text,n=e.on.response}r.xhr&&r.xhr.response?o.data=r.xhr.response:o.data||(o.data=o.statusText),n&&n(o)})},SuperagentHttpClient.prototype.binaryRequest=function(e){return!!e&&(/^image/i.test(e)||/^application\/pdf/.test(e)||/^application\/octet-stream/.test(e))};
...
"use strict";function itemByPriority(e,t){if(_.isEmpty(t))return e[0];for(var r=0,i=t.length;r<i;r++)if(e.indexOf(t[r])>-1)return t[r];return e[0]}var _={cloneDeep:require("lodash-compat/lang/cloneDeep"),isUndefined:require("lodash-compat/lang/isUndefined"),isEmpty:require("lodash-compat/lang/isEmpty"),isObject:require("lodash-compat/lang/isObject")},helpers=require("../helpers"),Model=require("./model"),SwaggerHttp=require("../http"),Q=require("q"),Operation=module.exports=function(e,t,r,i,s,o,a,n,l){var p=[];e=e||{},o=o||{},e&&e.options&&(this.client=e.options.client||null,this.requestInterceptor=e.options.requestInterceptor||null,this.responseInterceptor=e.options.responseInterceptor||null,this.requestAgent=e.options.requestAgent),this.authorizations=o.security,this.basePath=e.basePath||"/",this.clientAuthorizations=l,this.consumes=o.consumes||e.consumes||["application/json"],this.produces=o.produces||e.produces||["application/json"],this.deprecated=o.deprecated,this.description=o.description,this.host=e.host,this.method=i||p.push("Operation "+r+" is missing method."),this.models=n||{},this.nickname=r||p.push("Operations must have a nickname."),this.operation=o,this.operations={},this.parameters=null!==o?o.parameters||[]:{},this.parent=e,this.path=s||p.push("Operation "+this.nickname+" is missing path."),this.responses=o.responses||{},this.scheme=t||e.scheme||"http",this.schemes=o.schemes||e.schemes,this.security=o.security||e.security,this.summary=o.summary||"",this.timeout=e.timeout,this.type=null,this.useJQuery=e.useJQuery,this.jqueryAjaxCache=e.jqueryAjaxCache,this.enableCookies=e.enableCookies;var h;if(this.host||("undefined"!=typeof window?this.host=window.location.host:this.host="localhost"),this.parameterMacro=e.parameterMacro||function(e,t){return t.default},this.inlineModels=[],"/"!==this.basePath&&"/"===this.basePath.slice(-1)&&(this.basePath=this.basePath.slice(0,-1)),"string"==typeof this.deprecated)switch(this.deprecated.toLowerCase()){case"true":case"yes":case"1":this.deprecated=!0;break;case"false":case"no":case"0":case null:this.deprecated=!1;break;default:this.deprecated=Boolean(this.deprecated)}var u,c;if(a)for(h in a)(c=new Model(h,a[h],this.models,e.modelPropertyMacro))&&(this.models[h]=c);else a={};for(u=0;u<this.parameters.length;u++){var d,m=this.parameters[u];m.default=this.parameterMacro(this,m),"array"===m.type&&(m.isList=!0,m.allowMultiple=!0);var f=this.getType(m);f&&"boolean"===f.toString().toLowerCase()&&(m.allowableValues={},m.isList=!0,m.enum=[!0,!1]);for(h in m)helpers.extractExtensions(h,m);void 0!==m["x-example"]&&(d=m["x-example"],m.default=d),m["x-examples"]&&void 0!==(d=m["x-examples"].default)&&(m.default=d);var y=m.enum||m.items&&m.items.enum;if(void 0!==y){var v;for(m.allowableValues={},m.allowableValues.values=[],m.allowableValues.descriptiveValues=[],v=0;v<y.length;v++){var g=y[v],b=g===m.default||g+""===m.default;m.allowableValues.values.push(g),m.allowableValues.descriptiveValues.push({value:g+"",isDefault:b})}}if("array"===m.type&&(f=[f],void 0===m.allowableValues&&(delete m.isList,delete m.allowMultiple)),void 0===m.type){var x=m.schema;x&&x.$ref&&(c=this.models[helpers.simpleRef(x.$ref)])&&c.definition.title&&(m.type=c.definition.title)}m.modelSignature={type:f,definitions:this.models},m.signature=this.getModelSignature(f,this.models).toString(),m.sampleJSON=this.getModelSampleJSON(f,this.models),m.responseClassSignature=m.signature}var O,w,C,A=this.responses;A[200]?(C=A[200],w="200"):A[201]?(C=A[201],w="201"):A[202]?(C=A[202],w="202"):A[203]?(C=A[203],w="203"):A[204]?(C=A[204],w="204"):A[205]?(C=A[205],w="205"):A[206]?(C=A[206],w="206"):A.default&&(C=A.default,w="default");for(O in A)if(helpers.extractExtensions(O,A),"string"==typeof O&&-1===O.indexOf("x-")){var M=A[O];if("object"==typeof M&&"object"==typeof M.headers){var P=M.headers;for(var j in P){var q=P[j];if("object"==typeof q)for(var Q in q)helpers.extractExtensions(Q,q)}}}if(C)for(O in C)helpers.extractExtensions(O,C);if(C&&C.schema){var I,k=this.resolveModel(C.schema,a);delete A[w],k?(this.successResponse={},I=this.successResponse[w]=k):C.schema.type&&"object"!==C.schema.type&&"array"!==C.schema.type?(this.successResponse={},I=this.successResponse[w]=C.schema):(this.successResponse={},I=this.successResponse[w]=new Model(void 0,C.schema||{},this.models,e.modelPropertyMacro)),I&&(I.vendorExtensions=C.vendorExtensions,C.description&&(I.description=C.description),C.examples&&(I.examples=C.examples),C.headers&&(I.headers=C.headers)),this.type=C}return p.length>0&&this.resource&&this.resource.api&&this.resource.api.fail&&this.resource.api.fail(p),this};Operation.prototype.isDefaultArrayItemValue=function(e,t){return t.default&&Array.isArray(t.default)?-1!==t.default.indexOf(e):e===t.default},Operation.prototype.getType=function(e){var t,r=e.type,i=e.format,s=!1;"integer"===r&&"int32"===i?t="integer":"integer"===r&&"int64"===i?t="long":"integer"===r?t="integer":"string"===r?t="date-time"===i?"date-time":"date"===i?"date":"string":"number"===r&&"float"===i?t="float":"number"===r&&"double"===i?t="double":"number"===r?t="double":"boolean"===r?t="boolean":"array"===r?(s=!0,e.items&&(t=this.getType(e.items))):"file"===r&&(t="file"),e.$ref&&(t=helpers.simpleRef(e.$ref));var o=e.schema;if(o){var a=o.$ref;return a?(a=helpers.simpleRef(a),s?[a]:a):"object"===o.type?this.addInlineModel(o):this.getType(o)}return s?[t]:t},Operation.prototype.addInlineModel=function(e){var t=this.inlineModels.length,r=this.resolveModel(e,{});return r?(this.inlineModels.push(r),"Inline Model "+t):null},Operation.prototype.getInlineModel=function(e){if(/^Inline Model \d+$/.test(e)){var t=parseInt(e.substr("Inline Model".length).trim(),10);return this.inlineModels[t]}return null},Operation.prototype.resolveModel=function(e,t){if(void 0!==e.$ref){var r=e.$ref;if(0===r.indexOf("#/definitions/")&&(r=r.substring("#/definitions/".length)),t[r])return new Model(r,t[r],this.models,this.parent.modelPropertyMacro)}else if(e&&"object"==typeof e&&("object"===e.type||_.isUndefined(e.type)))return new Model(void 0,e,this.models,this.parent.modelPropertyMacro);return null},Operation.prototype.help=function(e){for(var t=this.nickname+": "+this.summary+"\n",r=0;r<this.parameters.length;r++){var i=this.parameters[r],s=i.signature;t+="\n  * "+i.name+" ("+s+"): "+i.description}return void 0===e&&helpers.log(t),t},Operation.prototype.getModelSignature=function(e,t){var r,i;return e instanceof Array&&(i=!0,e=e[0]),void 0===e?(e="undefined",r=!0):t[e]?(e=t[e],r=!1):this.getInlineModel(e)?(e=this.getInlineModel(e),r=!1):r=!0,r?i?"Array["+e+"]":e.toString():e.getMockSignature()},Operation.prototype.supportHeaderParams=function(){return!0},Operation.prototype.supportedSubmitMethods=function(){return this.parent.supportedSubmitMethods},Operation.prototype.getHeaderParams=function(e){for(var t=this.setContentTypes(e,{}),r={},i=0;i<this.parameters.length;i++){var s=this.parameters[i];"header"===s.in&&(r[s.name.toLowerCase()]=s)}for(var o in e){var a=r[o.toLowerCase()];if(void 0!==a){var n=e[o];Array.isArray(n)&&(n=n.toString()),t[a.name]=n}}return t},Operation.prototype.urlify=function(e,t){for(var r={},i=this.path.replace(/#.*/,""),s="",o=0;o<this.parameters.length;o++){var a=this.parameters[o];if(void 0!==e[a.name]){var n;if("string"===a.type&&"password"===a.format&&t&&(n=!0),"path"===a.in){var l=new RegExp("{"+a.name+"}","gi"),p=e[a.name];Array.isArray(p)?p=this.encodePathCollection(a.collectionFormat,a.name,p,n):void 0!==a["x-escape"]&&!0!==a["x-escape"]||(p=this.encodePathParam(p,n)),i=i.replace(l,p)}else if("query"===a.in&&void 0!==e[a.name])if(""===s&&i.indexOf("?")<0?s+="?":s+="&",void 0!==a.collectionFormat){var h=e[a.name];Array.isArray(h)?s+=this.encodeQueryCollection(a.collectionFormat,a.name,h,n):s+=this.encodeQueryKey(a.name)+"="+this.encodeQueryParam(e[a.name],n)}else s+=this.encodeQueryKey(a.name)+"="+this.encodeQueryParam(e[a.name],n);else"formData"===a.in&&(r[a.name]=e[a.name])}else if("query"===a.in&&void 0===e[a.name]&&!0===a.allowEmptyValue)if(""===s&&i.indexOf("?")<0?s+="?":s+="&",void 0!==a.collectionFormat||"array"===a.type){var h,u=a.collectionFormat||"multi";Array.isArray(h)?s+=this.encodeQueryCollection(u,a.name,h,n):s+=this.encodeQueryCollection(u,a.name,[h],n)}else s+=this.encodeQueryKey(a.name)+"="+this.encodeQueryParam("",n)}var c=this.scheme+"://"+this.host;return"/"!==this.basePath&&(c+=this.basePath),c+i+s},Operation.prototype.getMissingParams=function(e){var t,r=[];for(t=0;t<this.parameters.length;t++){var i=this.parameters[t];!0===i.required&&void 0===e[i.name]&&(r=i.name)}return r},Operation.prototype.getBody=function(e,t,r){for(var i,s,o,a,n,l={},p=!1,h=0;h<this.parameters.length;h++)if(s=this.parameters[h],void 0!==t[s.name]){var u;"string"===s.type&&"password"===s.format&&(u="password"),"body"===s.in?o=t[s.name]:"formData"===s.in&&(l[s.name]={param:s,value:t[s.name],password:u},i=!0)}else"body"===s.in&&(p=!0);if(p&&void 0===o){var c=e["Content-Type"];c&&0===c.indexOf("application/json")&&(o="{}")}var d=!1;if(e["Content-Type"]&&e["Content-Type"].indexOf("multipart/form-data")>=0&&(d=!0),i&&!d){var m="";for(a in l){s=l[a].param,n=l[a].value;var f;r&&r.maskPasswords&&(f=l[a].password),void 0!==n&&(Array.isArray(n)?(""!==m&&(m+="&"),m+=this.encodeQueryCollection(s.collectionFormat,a,n,f)):(""!==m&&(m+="&"),m+=encodeURIComponent(a)+"="+mask(encodeURIComponent(n),f)))}o=m}else if(d){var y;if("function"==typeof FormData){y=new FormData,y.type="formData";for(a in l)if(s=l[a].param,void 0!==(n=t[a]))if("[object File]"==={}.toString.apply(n))y.append(a,n);else if("file"===n.type&&n.value)y.append(a,n.value);else if(Array.isArray(n))if("multi"===s.collectionFormat){y.delete(a);for(var v in n)y.append(a,n[v])}else y.append(a,this.encodeQueryCollection(s.collectionFormat,a,n).split("=").slice(1).join("="));else y.append(a,n);o=y}else{y={};for(a in l)if(n=t[a],Array.isArray(n)){var g,b=s.collectionFormat||"multi";if("ssv"===b)g=" ";else if("pipes"===b)g="|";else if("tsv"===b)g="\t";else{if("multi"===b){y[a]=n;break}g=","}var x;n.forEach(function(e){x?x+=g:x="",x+=e}),y[a]=x}else y[a]=n;o=y}e["Content-Type"]="multipart/form-data"}return o},Operation.prototype.getModelSampleJSON=function(e,t){var r,i,s;if(t=t||{},r=e instanceof Array,s=r?e[0]:e,t[s]?i=t[s].createJSONSample():this.getInlineModel(s)&&(i=this.getInlineModel(s).createJSONSample()),i){if("string"==typeof(i=r?[i]:i))return i;if(_.isObject(i)){var o=i;if(i instanceof Array&&i.length>0&&(o=i[0]),o.nodeName&&"Node"==typeof o){var a=(new XMLSerializer).serializeToString(o);return this.formatXml(a)}return JSON.stringify(i,null,2)}return i}},Operation.prototype.do=function(e,t,r,i,s){return this.execute(e,t,r,i,s)},Operation.prototype.execute=function(e,t,r,i,s){var o,a,n,l,p=e||{},h={};_.isObject(t)&&(h=t,o=r,a=i),l=void 0!==h.timeout?h.timeout:this.timeout,this.client&&(h.client=this.client),this.requestAgent&&(h.requestAgent=this.requestAgent),!h.requestInterceptor&&this.requestInterceptor&&(h.requestInterceptor=this.requestInterceptor),!h.responseInterceptor&&this.responseInterceptor&&(h.responseInterceptor=this.responseInterceptor),"function"==typeof t&&(o=t,a=r),this.parent.usePromise?n=Q.defer():(o=o||this.parent.defaultSuccessCallback||helpers.log,a=a||this.parent.defaultErrorCallback||helpers.log),void 0===h.useJQuery&&(h.useJQuery=this.useJQuery),void 0===h.jqueryAjaxCache&&(h.jqueryAjaxCache=this.jqueryAjaxCache),void 0===h.enableCookies&&(h.enableCookies=this.enableCookies);var u=this.getMissingParams(p);if(u.length>0){var c="missing required params: "+u;return helpers.fail(c),this.parent.usePromise?(n.reject(c),n.promise):(a(c,s),{})}var d,m=this.getHeaderParams(p),f=this.setContentTypes(p,h),y={};for(d in m)y[d]=m[d];for(d in f)y[d]=f[d];var v=this.getBody(f,p,h),g=this.urlify(p,h.maskPasswords);if(g.indexOf(".{format}")>0&&y){var b=y.Accept||y.accept;b&&b.indexOf("json")>0?g=g.replace(".{format}",".json"):b&&b.indexOf("xml")>0&&(g=g.replace(".{format}",".xml"))}var x={url:g,method:this.method.toUpperCase(),body:v,enableCookies:h.enableCookies,useJQuery:h.useJQuery,jqueryAjaxCache:h.jqueryAjaxCache,deferred:n,headers:y,clientAuthorizations:h.clientAuthorizations,operation:this,connectionAgent:this.connectionAgent,on:{response:function(e){return n?(n.resolve(e),n.promise):o(e,s)},error:function(e){return n?(n.reject(e),n.promise):a(e,s)}}};return l&&(x.timeout=l),this.clientAuthorizations.apply(x,this.operation.security),!0===h.mock?(h.requestInterceptor&&h.requestInterceptor.apply(x),x):(new SwaggerHttp).execute(x,h)},Operation.prototype.setContentTypes=function(e,t){var r,i,s=this.parameters,o=e.parameterContentType||itemByPriority(this.consumes,["application/json","application/yaml"]),a=t.responseContentType||itemByPriority(this.produces,["application/json","application/yaml"]),n=[],l=[],p={};for(i=0;i<s.length;i++){var h=s[i];if("formData"===h.in)"file"===h.type?n.push(h):l.push(h);else if("header"===h.in&&t){var u=h.name,c=t[h.name];void 0!==t[h.name]&&(p[u]=c)}else"body"===h.in&&void 0!==e[h.name]&&(r=e[h.name])}var d=r||n.length||l.length;if("post"===this.method||"put"===this.method||"patch"===this.method||("delete"===this.method||"get"===this.method)&&d){if(t.requestContentType&&(o=t.requestContentType),l.length>0){if(o=void 0,t.requestContentType)o=t.requestContentType;else if(n.length>0)o="multipart/form-data";else if(this.consumes&&this.consumes.length>0)for(var m in this.consumes){var f=this.consumes[m];0!==f.indexOf("application/x-www-form-urlencoded")&&0!==f.indexOf("multipart/form-data")||(o=f)}void 0===o&&(o="application/x-www-form-urlencoded")}}else o=null;return o&&this.consumes&&-1===this.consumes.indexOf(o)&&helpers.log("server doesn't consume "+o+", try "+JSON.stringify(this.consumes)),this.matchesAccept(a)||helpers.log("server can't produce "+a),o&&""!==r||"application/x-www-form-urlencoded"===o?p["Content-Type"]=o:this.consumes&&this.consumes.length>0&&"application/x-www-form-urlencoded"===this.consumes[0]&&(p["Content-Type"]=this.consumes[0]),a&&(p.Accept=a),p},Operation.prototype.matchesAccept=function(e){return!e||!this.produces||(-1!==this.produces.indexOf(e)||-1!==this.produces.indexOf("*/*"))},Operation.prototype.asCurl=function(e,t){var r={mock:!0,maskPasswords:!0};if("object"==typeof t)for(var i in t)r[i]=t[i];var s=this.execute(e,r);this.clientAuthorizations.apply(s,this.operation.security);var o=[];if(o.push("-X "+this.method.toUpperCase()),void 0!==s.headers){var a;for(a in s.headers){var n=s.headers[a];"string"==typeof n&&(n=n.replace(/\'/g,"\\u0027")),o.push("--header '"+a+": "+n+"'")}}var l=!1,p=!1,h=s.headers["Content-Type"];if(h&&0===h.indexOf("application/x-www-form-urlencoded")?l=!0:h&&0===h.indexOf("multipart/form-data")&&(l=!0,p=!0),s.body){var u;if(_.isObject(s.body)){if(p){p=!0;for(var c=0;c<this.parameters.length;c++){var d=this.parameters[c];if("formData"===d.in){u||(u="");var m;if(m="function"==typeof FormData&&s.body instanceof FormData?s.body.getAll(d.name):s.body[d.name])if("file"===d.type)if(Array.isArray(m))for(var f in m)m[f].name&&(u+="-F "+d.name+'=@"'+m[f].name+'" ');else m.name&&(u+="-F "+d.name+'=@"'+m.name+'" ');else if(Array.isArray(m))if("multi"===d.collectionFormat)for(var y in m)u+="-F "+this.encodeQueryKey(d.name)+"="+mask(m[y],d.format)+" ";else u+="-F "+this.encodeQueryCollection(d.collectionFormat,d.name,mask(m,d.format))+" ";else u+="-F "+this.encodeQueryKey(d.name)+"="+mask(m,d.format)+" "}}}u||(u=JSON.stringify(s.body))}else u=s.body;u=l&&!p?u.replace(/\'/g,"%27").replace(/@/g,"%40"):u.replace(/\'/g,"\\u0027"),p?o.push(u):o.push("--data-raw '"+u+"'")}return"curl "+o.join(" ")+" '"+s.url+"'"},Operation.prototype.encodePathCollection=function(e,t,r,i){var s,o="",a="";for(a="ssv"===e?"%20":"tsv"===e?"%09":"pipes"===e?"|":",",s=0;s<r.length;s++)0===s?o=this.encodeQueryParam(r[s],i):o+=a+this.encodeQueryParam(r[s],i);return o},Operation.prototype.encodeQueryCollection=function(e,t,r,i){var s,o="";if("default"===(e=e||"default")||"multi"===e)for(s=0;s<r.length;s++)s>0&&(o+="&"),o+=this.encodeQueryKey(t)+"="+mask(this.encodeQueryParam(r[s]),i);else{var a="";if("csv"===e)a=",";else if("ssv"===e)a="%20";else if("tsv"===e)a="%09";else if("pipes"===e)a="|";else if("brackets"===e)for(s=0;s<r.length;s++)0!==s&&(o+="&"),o+=this.encodeQueryKey(t)+"[]="+mask(this.encodeQueryParam(r[s]),i);if(""!==a)for(s=0;s<r.length;s++)0===s?o=this.encodeQueryKey(t)+"="+this.encodeQueryParam(r[s]):o+=a+this.encodeQueryParam(r[s])}return o},Operation.prototype.encodeQueryKey=function(e){return encodeURIComponent(e).replace("%5B","[").replace("%5D","]").replace("%24","$")},Operation.prototype.encodeQueryParam=function(e,t){return t?"******":void 0!==e&&null!==e?encodeURIComponent(e):""},Operation.prototype.encodePathParam=function(e,t){return encodeURIComponent(e,t)};var mask=function(e,t){return"string"==typeof t&&"password"===t?"******":e};
...
(function (global){
function bufferClone(r){var e=new ArrayBuffer(r.byteLength);return new Uint8Array(e).set(new Uint8Array(r)),e}var ArrayBuffer=global.ArrayBuffer,Uint8Array=global.Uint8Array;module.exports=bufferClone;
...
function createBaseEach(e,t){return function(r,n){var a=r?getLength(r):0;if(!isLength(a))return e(r,n);for(var c=t?a:-1,g=toObject(r);(t?c--:++c<a)&&!1!==n(g[c],c,g););return r}}var getLength=require("./getLength"),isLength=require("./isLength"),toObject=require("./toObject");module.exports=createBaseEach;


},{"./getLength":112,"./isLength":125,"./toObject":135}],99:[function(require,module,exports){
function createBaseFor(e){return function(r,t,o){for(var a=toObject(r),c=o(r),n=c.length,u=e?n:-1;e?u--:++u<n;){var b=c[u];if(!1===t(a[b],b,a))break}return r}}var toObject=require("./toObject");module.exports=createBaseFor;


},{"./toObject":135}],100:[function(require,module,exports){
(function (global){
function createBindWrapper(r,e){function t(){return(this&&this!==global&&this instanceof t?a:r).apply(e,arguments)}var a=createCtorWrapper(r);return t}var createCtorWrapper=require("./createCtorWrapper");module.exports=createBindWrapper;
...
function isKey(r,e){var t=typeof r;return!!("string"==t&&reIsPlainProp.test(r)||"number"==t)||!isArray(r)&&(!reIsDeepProp.test(r)||null!=e&&r in toObject(e))}var isArray=require("../lang/isArray"),toObject=require("./toObject"),reIsDeepProp=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\n\\]|\\.)*?\1)\]/,reIsPlainProp=/^\w*$/;module.exports=isKey;
